...
import { Settings, ChevronRight, QrCode, Server } from 'lucide-react-native';
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      <ScrollView className="flex-1">
        ...
        <View className="p-4">
          ...
          <TouchableOpacity className="flex-row items-center justify-between p-4 bg-card rounded-xl mb-2">
