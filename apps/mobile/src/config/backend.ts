...
export const DEFAULT_FIREBASE_URL =
  "https://us-central1-drop-the-tabs.cloudfunctions.net/api";

// Get Firebase URL with project ID
export function getFirebaseUrl(projectId: string = "drop-the-tabs"): string {
